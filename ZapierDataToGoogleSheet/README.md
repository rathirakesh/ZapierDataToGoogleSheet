ZapierDataToGoogleSheet App using React Native.
...
1) Clone repository   
```
git clone https://github.com/rathirakesh/ZapierDataToGoogleSheet
cd ZapierDataToGoogleSheet
npm install
...
#Creating this app 
1.  react-native init  ZapierDataToGoogleSheet
2.  cd ZapierDataToGoogleSheet
```
    2a) npm install --save react-native-router-flux
